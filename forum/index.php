    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="home.php">Virtual Classroom</a>
            </div>
        ...
        <!-- /.container-fluid -->
			...
			<div class="container" style="margin:8% auto;">
				<div class="col-sm-4 col-md-3">
					<h2> Why join us? </h2>
					<p><font face="verdana" color="green"><strong>
Try it Yourself »
We here at Synergy Software Solution have designed something out of the box here. A blend
					   of discussion forum, social networking and live streaming, we are trying to provide an all blend interface for 
